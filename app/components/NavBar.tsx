...
const NavBar: FC = () => {
  ...
  return (
    <nav className="fixed z-10 flex w-full items-center justify-between bg-[rgba(83,130,172,0.171)] p-2.5 backdrop-blur-[10px]">
      <Link href="/">
        <img
          src="/Logo.png"
      ...
      <div className="flex items-center ">
        ...
        />
        <button
          className="mr-[50px] flex flex-col gap-1.5 md:hidden"
